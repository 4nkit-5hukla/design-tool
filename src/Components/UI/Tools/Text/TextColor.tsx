...
const TextColor = () => {
  ...
  const { useColorSet, setColorSet } = useAppState();
  ...
  const selectColor = (color: string, colorSet: string) => {
    setColorSet((useColorSet: string) =>
      useColorSet !== colorSet ? colorSet : useColorSet
    );
  ...
  useEffect(() => {
    if (selectedEl) {
      if (selectedEl.fill) {
        setSelectedColor(selectedEl.fill);
      }
    }
  }, [selectedEl]);
        ...
        >
          ...
          <Box gap={1.225} marginBottom={3.5} display="flex" flexWrap="wrap">
            ...
            <Box
              ...
              justifyContent="center"
              value="transparent"
              selected={"transparent" === selectedColor}
              height={36}
              width={36}
              onClick={() => selectColor("transparent", "designColors")}
              sx={{
                boxShadow: "0 0 1px 4px #eef5f9",
              ...
              designColors.map((color: string, index: number) => (
                <Box
                  ...
                  selected={
                    ...
                    designColors &&
                    designColors[index] === selectedColor
                  }
                  height={36}
                  width={36}
                  onClick={() => selectColor(color, "designColors")}
                  sx={{
                    boxShadow: "0 0 1px 4px #eef5f9",
          ...
          <Box gap={1.225} marginBottom={3.5} display="flex" flexWrap="wrap">
            {[
              ...
              <Box
                ...
                height={36}
                width={36}
                onClick={() => selectColor(color, "brandColor")}
                sx={{
                  boxShadow: "0 0 1px 4px #eef5f9",
          ...
          <Box gap={1.225} marginBottom={3.5} display="flex" flexWrap="wrap">
            {swatchColor.map((color, index) => (
              <Box
                ...
                height={36}
                width={36}
                onClick={() => selectColor(color, "swatchColor")}
                sx={{
                  boxShadow: "0 0 1px 4px #eef5f9",
